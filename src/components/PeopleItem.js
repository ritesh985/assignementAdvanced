                ...
                <div>
                    <Col xs={24} sm={24} md={12} lg={8} xl={6}>
                        <Card style={{ width: 300, margin:'15px auto' } }
                            ...
                            actions={[<button style={{background:'none' ,border:'none', outline:'none', cursor:'pointer'}} onClick={this.toggleState}> <Icon type="heart"   style={{fontSize:'20px', color:'#F50000'}} theme={this.state.theme}/></button>,
                                <Icon type="edit" onClick={this.showModal} />, 
                                <Icon type="delete" onClick={()=>this.props.removeItem(this.props.person)} theme="filled" />]}
                            >
                        <div>
